...
# SEND PATCH REQUEST TO LOAD GOOGLE.COM
echo "📡 Sending 'load_website' PATCH request to load google.com..."

# UPDATE WITH YOUR DISPLAY ID

PATCH_PAYLOAD="{\"id\":\"2d047a97-9882-43f0-b953-88309c0669a8\",\"name\":\"load_website\",\"args\":{\"url\":\"http://google.com\"}}"
