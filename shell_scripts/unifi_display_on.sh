...
# UPDATE THIS WITH YOUR DISPLAY ID
...
# SEND PATCH REQUEST TO TURN ON DISPLAY
echo "📡 Sending 'display_on' PATCH request..."

# UPDATE THIS WITH YOUR DISPLAY ID

PATCH_PAYLOAD="{\"id\":\"06ad25d0-b087-46de-8e9b-7b18339e7238\",\"name\":\"display_on\",\"args\":{}}"
